 ...
 * This file demonstrates how to integrate Treblexeno with a web frontend
 */

// For React/Vue/Angular applications
export class TreblexenoClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new TreblexenoClient(provider, contractAddress);
